...
*       >Yo Bro
*       >HYo Im Sorry Bro
*       >For breaking the code wii know
*       >Wish you the best yo <3
* 
* 2. Fade out Haiku :)
* 
...
function preload(){
	sound0 = loadSound("assets/sound/soccerPractice.mp3");
}
...
function setup() {
	...
	hT = "Hey Dude";
	l1 = "Hey I'm sorry Dude";
	l2 = "For breaking the code wii know";
	l3 = "Wish you the best yo <3";
