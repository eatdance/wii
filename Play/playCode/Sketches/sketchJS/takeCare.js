...
*       >Take Care
*       >I've hurt golden hearts
*       >Not for fun and not for games
*       >Just for carelessness
* 
* 2. Fade out Haiku :)
* 
...
function setup() {
	...
	hT = "Take Care";
	l1 = "I've hurt golden hearts";
	l2 = "Not for fun and not for games";
	l3 = "Just for carelessness";
